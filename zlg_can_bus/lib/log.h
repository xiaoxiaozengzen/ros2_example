...
#define LOG_ALWAYS(fmt, ...)                                                   \
  TheLog()->Write(CLog::SYS, "%s<%d>: " fmt, __FUNCTION__, __LINE__,           \
                  ##__VA_ARGS__)

#if ENABLE_LOG_INFO
#define LOG_INFO(fmt, ...)                                                     \
  TheLog()->Write(CLog::INFO, "%s<%d>: " fmt, __FUNCTION__, __LINE__,          \
                  ##__VA_ARGS__)
...
#define LOG_WARN(fmt, ...)                                                     \
  TheLog()->Write(CLog::WARN, "%s<%d>: " fmt, __FUNCTION__, __LINE__,          \
                  ##__VA_ARGS__)

#if ENABLE_LOG_ERR
#define LOG_ERR(fmt, ...)                                                      \
  TheLog()->Write(CLog::ERR, "%s<%d>: " fmt, __FUNCTION__, __LINE__,           \
                  ##__VA_ARGS__)
#else // ENABLE_LOG_ERR
#define LOG_ERR(fmt, ...)
