...
rosbag2_get_subscription_options(const rclcpp::QoS &qos) {
...
GenericSubscription::GenericSubscription(
    ...
    : SubscriptionBase(node_base, ts, topic_name,
                       rosbag2_get_subscription_options(qos), true),
...
const rclcpp::QoS &GenericSubscription::qos_profile() const { return qos_; }
